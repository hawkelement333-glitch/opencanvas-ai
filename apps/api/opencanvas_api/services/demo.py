...
def _ai_provenance_records() -> list[object]:
    ...
    records: list[object] = [
        AIExecutionNode(
            ...
            node_id_snapshot=DOCUMENT_ONE_NODE_ID,
            selected_order=0,
            node_type="document",
            node_revision=0,
            ...
            document_id=DOCUMENT_ONE_ID,
            document_id_snapshot=DOCUMENT_ONE_ID,
            **_timestamps(),
        ),
        AIExecutionNode(
            id=_id(202),
            ...
            node_id_snapshot=DOCUMENT_TWO_NODE_ID,
            selected_order=1,
            node_type="document",
            node_revision=0,
            ...
            document_id=DOCUMENT_TWO_ID,
            document_id_snapshot=DOCUMENT_TWO_ID,
            **_timestamps(),
        ),
        AIExecutionNode(
            id=_id(203),
            ...
            node_id_snapshot=NOTE_HYPOTHESIS_ID,
            selected_order=2,
            node_type="note",
            node_revision=0,
        ...
        AIExecutionChunk(
            ...
            request_id=DEMO_REQUEST_ID,
            chunk_id=CHUNK_ONE_ID,
            chunk_id_snapshot=CHUNK_ONE_ID,
            document_id=DOCUMENT_ONE_ID,
            document_id_snapshot=DOCUMENT_ONE_ID,
        ...
        AIExecutionChunk(
            ...
            request_id=DEMO_REQUEST_ID,
            chunk_id=CHUNK_TWO_ID,
            chunk_id_snapshot=CHUNK_TWO_ID,
            document_id=DOCUMENT_TWO_ID,
            document_id_snapshot=DOCUMENT_TWO_ID,
            chunk_index_snapshot=0,
            rank=2,
